  ...
  return (
    <motion.div
      ...
      className={`mb-6 rounded-2xl border shadow-lg overflow-hidden ${
        isCritical 
          ? "bg-red-50/90 border-red-200 dark:bg-red-950/30 dark:border-red-900 shadow-red-500/10" 
          : "bg-orange-50/90 border-orange-200 dark:bg-orange-950/30 dark:border-orange-900 shadow-orange-500/10"
      }`}
    >
      <div 
        className={`px-5 py-4 flex items-center justify-between cursor-pointer ${
          isCritical ? "hover:bg-red-100/50 dark:hover:bg-red-900/30" : "hover:bg-orange-100/50 dark:hover:bg-orange-900/30"
        } transition-colors`}
        onClick={() => setExpanded(!expanded)}
      >
        <div className="flex items-center gap-4">
          <div className={`p-2.5 rounded-full ${isCritical ? "bg-red-100 text-red-600 dark:bg-red-900 dark:text-red-300" : "bg-orange-100 text-orange-600 dark:bg-orange-900 dark:text-orange-300"}`}>
            {isCritical ? (
          ...
          <div>
            <div className="flex items-center gap-3 mb-1">
              <h3 className={`font-black uppercase tracking-widest text-sm ${isCritical ? "text-red-700 dark:text-red-400" : "text-orange-700 dark:text-orange-400"}`}>
            ...
            <p className={`text-lg font-bold ${isCritical ? "text-red-950 dark:text-red-100" : "text-orange-950 dark:text-orange-100"}`}>
      ...
      <AnimatePresence>
        {expanded && (
          <motion.div
            ...
            className={`border-t px-6 py-5 ${isCritical ? "border-red-200 dark:border-red-900/50" : "border-orange-200 dark:border-orange-900/50"}`}
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h4 className={`text-xs font-bold uppercase tracking-widest mb-3 ${isCritical ? "text-red-800 dark:text-red-300" : "text-orange-800 dark:text-orange-300"}`}>
                  Contributing Clinical Factors
                </h4>
                <ul className="space-y-2">
                  {data.contributing_factors.map((factor, i) => (
                    <li key={i} className={`flex items-start gap-2 text-sm font-medium ${isCritical ? "text-red-900 dark:text-red-200" : "text-orange-900 dark:text-orange-200"}`}>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2 mb-4">
                  <div className="bg-black/10 dark:bg-white/10 p-2 rounded-lg text-center">
